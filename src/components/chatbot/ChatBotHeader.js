  ...
  _onSwitchWindowButtonClick(){
    ...
    render() {
        return (
            ...
            <div className='chatbot-logo-wrapper mydummy'>
...
{/* <div
  ...
  {this.props.logInData.isLogIn &&
              ...
              tabIndex="0" 
            >
              <i class="material-icons dp48">transfer_within_a_station</i> {this.props.notifications.length > 0 && <span className='dot'></span> } 
            </div>}
            </div>
          </div>  
        )
