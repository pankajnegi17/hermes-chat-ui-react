    ...
    await axios
      ...
      .then(
        function (res) {
          ...
          const socket = socketIOClient.connect(chatbot_api_host, {
            secure: true,
          });

          socket.on("handshake", (data) => {
            console.warn(
              `SOCKET Established!!!!!!!!!!! with socketId: ${data.socketId}`
            );
